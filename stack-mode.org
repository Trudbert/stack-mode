...
** Filters used
#+begin_src emacs-lisp
  (setq stack-network-site-browsing-filter "!2*cjqC8qJoVJ-U9fz9DfA")
#+end_src
** Default Key-map
...
#+begin_src emacs-lisp
  (defvar stack-network-mode-map
    (let ((map (make-keymap)))
      ...
      (define-key map (kbd "C-u u") 'stack-network-do-profile-summary-for-user)
